...
- (IBAction)buttonTapped:(id)sender {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Alert!" message:@"Tap a response" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Choice 1", @"Choice 2", nil];
    [alertView show];
}
